      ...
      <div className="max-w-7xl mx-auto w-full flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left order-2 lg:order-1">
          ...
          <div className="mt-6 flex justify-center lg:justify-start gap-14 text-2xl">
            <a
              href="https://github.com/deepakkumar025/"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/deepak025"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="mailto:nideepak99@gmail.com"
              className="hover:text-red-400 transition-colors duration-200"
            >
              <FaEnvelope />
            </a>
            <a
              href="https://www.instagram.com/deepakkumar_8807/"
              target="_blank"
              rel="noopener noreferrer"
